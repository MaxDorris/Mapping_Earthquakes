...
legend.onAdd = function() {
  ...
  for (var i = 0; i < magnitudes.length; i++) {
    ...
    div.innerHTML += '<i style="background-color:' + colors[i] + '"></i> ' + magnitudes[i] + (magnitudes[i + 1] ? "&ndash;" + magnitudes[i + 1] + "<br>" : "+");
    // ([value] ? [if value exists, do something] : [if value dne, do something else])
  }
  return div;
};
